...
program
  ...
  .option('--name <alias>', 'Override indexed repository name with a stable alias')
  .option('--repo-alias <name>', 'Override indexed repository name with a stable alias (deprecated: use --name)')
