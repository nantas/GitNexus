...
- **Optional skill generation** via `npx -y @veewo/gitnexus@latest analyze --skills` — generates AI agent skills from KuzuDB knowledge graph (#171) — @zander-raycraft
...
- Auto-reindex hook that runs `npx -y @veewo/gitnexus@latest analyze` after commits and merges, with automatic embeddings preservation (#205) — @L1nusB
